...
st.title("Event Duration Matcher")

uploaded_files = st.file_uploader("Upload Events Files", type=[
                                  "json"], accept_multiple_files=True)
...
if uploaded_files:
    ...
    for uploaded_file in uploaded_files:
        if uploaded_file.name == "events_timeline.json":
            events_timeline = load_json(uploaded_file)
        elif uploaded_file.name == "event_dictionary.json":
            event_dictionary = load_json(uploaded_file)

    if events_timeline and event_dictionary:
