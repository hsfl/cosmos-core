...
int main(int argc, char *argv[])
{
    ...
    if ((iretn=agent_get_server(cinfo, (char *)node,(char *)"radio",waitsec,(beatstruc *)NULL)) > 0)
		exit (iretn);
...
//	RS232_OpenComport(SERIAL_USB0,19200); // 16=ttyUSB0, 19200bps
	...
	if (!(cinfo = agent_setup_server(NetworkType::UDP,(char *)node,(char *)"radio",1.,0,MAXBUFFERSIZE)))
		exit (iretn);
