...
//	cdata->physics.area = 200.;
	...
	for (size_t i=1; i<total_count; ++i)
	{
		...
		kepstruc kep;
		eci2kep(eci, kep);
		printf("%.15g\t%.10g\t%.10g\t%.10g\t%.10g\t%.10g\t%.10g\t", cmjd, eci.s.col[0], eci.s.col[1], eci.s.col[2], cdata->node.loc.pos.geod.s.col[0], cdata->node.loc.pos.geod.s.col[1], cdata->node.loc.pos.geod.s.col[2]);
		printf("%.10g\t%.10g\t%.10g\t%.10g\t%.10g\t%.10g\t", eci.v.col[0], eci.v.col[1], eci.v.col[2], cdata->node.loc.pos.geod.v.col[0], cdata->node.loc.pos.geod.v.col[1], cdata->node.loc.pos.geod.v.col[2]);
		printf("%.10g\t%.10g\t%.10g\t%.10g\t%.10g\t%.10g\t", eci.a.col[0], eci.a.col[1], eci.a.col[2], cdata->node.loc.pos.geod.a.col[0], cdata->node.loc.pos.geod.a.col[1], cdata->node.loc.pos.geod.a.col[2]);
