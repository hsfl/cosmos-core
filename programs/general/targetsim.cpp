...
//    double speed = sqrt(initialloc.pos.geod.v.lat * initialloc.pos.geod.v.lat + initialloc.pos.geod.v.lon * initialloc.pos.geod.v.lon);
    ...
    iretn = sim->AddNode("mother", Physics::Structure::HEX65W80H, Physics::Propagator::PositionTle, Physics::Propagator::AttitudeLVLH, Physics::Propagator::Thermal, Physics::Propagator::Electrical, Physics::Propagator::OrbitalEvent, tle);
