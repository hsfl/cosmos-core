...
IF(${BUILD_COSMOS_CORE_AGENT} MATCHES "ON")
    MESSAGE("Building Agent Library")
        add_subdirectory(${COSMOS_DEVEL}/core/libraries/agent ${CMAKE_BINARY_DIR}/libraries/agent)
...
IF(${BUILD_COSMOS_CORE_PHYSICS} MATCHES "ON")
    MESSAGE("Building Physics Library")
        add_subdirectory(${COSMOS_DEVEL}/core/libraries/physics ${CMAKE_BINARY_DIR}/libraries/physics)
...
IF(${BUILD_COSMOS_CORE_MATH} MATCHES "ON")
    ...
    add_subdirectory(${COSMOS_DEVEL}/core/libraries/math ${CMAKE_BINARY_DIR}/libraries/math)
...
IF(${BUILD_COSMOS_CORE_SUPPORT} MATCHES "ON")
    ...
    add_subdirectory(${COSMOS_DEVEL}/core/libraries/support ${CMAKE_BINARY_DIR}/libraries/support)
...
IF(${BUILD_COSMOS_CORE_DEVICES} MATCHES "ON")
    ...
    add_subdirectory(${COSMOS_DEVEL}/core/libraries/device ${CMAKE_BINARY_DIR}/libraries/device)
...
#    add_subdirectory(${COSMOS_DEVEL}/core/libraries/thirdparty/Eigen ${CMAKE_BINARY_DIR}/libraries/thirdparty/Eigen)
...
IF(${BUILD_COSMOS_CORE_THIRDPARTY_ZLIB} MATCHES "ON")
    ...
    add_subdirectory(${COSMOS_DEVEL}/core/libraries/thirdparty/zlib ${CMAKE_BINARY_DIR}/libraries/thirdparty/zlib)
...
IF(${BUILD_COSMOS_CORE_THIRDPARTY_JPEG} MATCHES "ON")
    ...
    add_subdirectory(${COSMOS_DEVEL}/core/libraries/thirdparty/jpeg ${CMAKE_BINARY_DIR}/libraries/thirdparty/jpeg)
...
IF(${BUILD_COSMOS_PROJECT_USER} MATCHES "ON")
    ...
    add_subdirectory(${COSMOS_DEVEL}/core/libraries)
...
IF(${BUILD_COSMOS_CORE_THIRDPARTY_PNG} MATCHES "ON")
    ...
    add_subdirectory(${COSMOS_DEVEL}/core/libraries/thirdparty/png ${CMAKE_BINARY_DIR}/libraries/thirdparty/png)
...
IF(${BUILD_COSMOS_CORE_THIRDPARTY_DIRENT} MATCHES "ON")
    ...
    add_subdirectory(${COSMOS_DEVEL}/core/libraries/thirdparty/dirent ${CMAKE_BINARY_DIR}/libraries/thirdparty/dirent)
...
#add_subdirectory(${COSMOS_DEVEL}/core/libraries/device/arduino ${CMAKE_BINARY_DIR}/libraries/device/arduino)
