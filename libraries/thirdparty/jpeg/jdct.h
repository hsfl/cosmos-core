 ...
 * for 8-bit samples, int32_t for 12-bit samples.  (NOTE: Floating-point DCT
...
#else
typedef int32_t DCTELEM;		/* must have 32 bits */
#endif
...
#else
typedef int32_t IFAST_MULT_TYPE;	/* need 32 bits for scaled quantizers */
...
#define MULTIPLY16C16(var,const)  (((int16_t) (var)) * ((int32_t) (const)))
#endif
