...
int32_t json_createpiece(cosmosstruc *cinfo, uint32_t struc_idx, DeviceType ctype, double emi=1.0, double abs=1.0, double hcap=0.9, double hcon=205.);
...
int32_t json_addpiece(cosmosstruc *cinfo, uint32_t struc_idx, DeviceType ctype, double emi=1.0, double abs=1.0, double hcap=0.9, double hcon=205.);
