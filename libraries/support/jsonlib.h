...
int32_t json_setup_node(std::string node, cosmosstruc *cdata, bool create_flag = false);
int32_t json_setup_node(cosmosstruc *cdata, jsonnode &json, bool create_flag = false);
int32_t json_setup_node_file(std::string node, cosmosstruc *cdata, jsonnode &json, bool create_flag = false);
