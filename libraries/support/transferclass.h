...
//! \defgroup transferclass_constants File Transfer constants
//! @{
...
{
    static const uint8_t STATE_NONE = 0x00;
    static const uint8_t STATE_REQQUEUE = 0x01;
    static const uint8_t STATE_QUEUE = 0x02;
    static const uint8_t STATE_REQMETA = 0x03;
    static const uint8_t STATE_METADATA = 0x04;
    static const uint8_t STATE_REQDATA = 0x05;
    static const uint8_t STATE_DATA = 0x06;
    static const uint8_t STATE_CANCEL = 0x07;
    static const uint8_t STATE_COMPLETE = 0x08;
    static const uint8_t STATE_SIZE = 0x09;
}
...
namespace STATUS_TYPE	{
    //these bits reserved for PACKET_TYPES
    static const uint8_t STATUS_ALL_GOOD		= 128;  //10000000
    static const uint8_t STATUS_BAD_TX_ID		=  64;  //01000000
    static const uint8_t STATUS_NO_FILE_FOUND =  32;  //00100000
    static const uint8_t STATUS_HOLES_TO_FILL =  16;  //00010000
    static const uint8_t STATUS_SUCCESS		=   8;  //00001000
    static const uint8_t STATUS_NEED_METADATA =   4;	//00000100

    //these bits reserved for future STATUS_TYPES
    //static const uint8_t STATUS_1 =	4;	  //00000100
    static const uint8_t STATUS_2 =	2;	  //00000010
    static const uint8_t STATUS_3 =	 1;	  //00000001
}
...
//! \ingroup transferclass
//! \defgroup transferclass_typedefs File Transfer typedefs
//! @{
...
//! \ingroup transferclass
//! \defgroup transferclass_functions File Transfer functions
//! @{

//functions to verify whether a packet is a particular type
bool IS_MESSAGE(const uint8_t);
bool IS_REQUEST(const uint8_t);
bool IS_METADATA(const uint8_t);
bool IS_DATA(const uint8_t);
bool IS_REQDATA(const uint8_t);
bool IS_REQMETA(const uint8_t);
bool IS_COMPLETE(const uint8_t);

//functions to verify whether a request is of a particular type
bool IS_GET_REQUEST(const uint8_t);
bool IS_PUT_REQUEST(const uint8_t);
bool IS_DELETE_REQUEST(const uint8_t);
