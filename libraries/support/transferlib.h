...
#define PACKET_HEADER_CRC (PACKET_HEADER_TYPE + COSMOS_SIZEOF(PACKET_TYPE))
...
#define PACKET_METALONG_NODE_NAME (PACKET_HEADER_CRC + COSMOS_SIZEOF(PACKET_CRC))
...
#define PACKET_METASHORT_NODE_ID (PACKET_HEADER_CRC + COSMOS_SIZEOF(PACKET_CRC))
...
#define PACKET_DATA_NODE_ID (PACKET_HEADER_CRC + COSMOS_SIZEOF(PACKET_CRC))
...
#define PACKET_REQDATA_NODE_ID (PACKET_HEADER_CRC + COSMOS_SIZEOF(PACKET_CRC))
...
#define PACKET_REQMETA_NODE_ID (PACKET_HEADER_CRC + COSMOS_SIZEOF(PACKET_CRC))
...
#define PACKET_COMPLETE_NODE_ID (PACKET_HEADER_CRC + COSMOS_SIZEOF(PACKET_CRC))
...
#define PACKET_CANCEL_NODE_ID (PACKET_HEADER_CRC + COSMOS_SIZEOF(PACKET_CRC))
...
#define PACKET_QUEUE_NODE_ID (PACKET_HEADER_CRC + COSMOS_SIZEOF(PACKET_CRC))
